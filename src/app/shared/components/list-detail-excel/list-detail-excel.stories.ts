...
import { ListDetailExcelModule } from './list-detail-excel.module';

storiesOf('List Detail Excel', module)
    .add('ListDetailExcel Component', () => ({
        component: ListDetailExcelComponent,
        moduleMetadata: {
            imports: [
              ListDetailExcelModule,BrowserAnimationsModule
            ],
          },
        props: {
